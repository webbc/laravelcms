                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea class="form-control" id="inputDescription" rows="3"
                                                  placeholder="栏目描述" name="description"></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="url" type="text" class="form-control" id="inputName"
                                               placeholder="外部链接">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input name="sort" value="0" type="text" class="form-control" id="inputName" placeholder="排序">
                                    </div>

                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a class="btn btn-info" href="{{url('/admin/class/add')}}">添加栏目</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
<script>
    $(function () {
        $('#myModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer a').attr('href', '/admin/class/del/' + id);
        });
        $("#example1").DataTable({
            ...
            "columns": [
                ...
                {"data": "createtimestr"},
                {
                    ...
                    "defaultContent": "",
                    "render": function (data) {
                        return "<a href='/admin/article/index/" + data.id + "'>查看文章</a>&nbsp;&nbsp;|&nbsp;&nbsp;"
                                + "<a href='/admin/class/edit/" + data.id + "'>修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;"

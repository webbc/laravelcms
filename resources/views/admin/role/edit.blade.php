                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="parentid" class="form-control">
                                            @foreach($roles as $r)
                                                <option value="{{$r->id}}" {{$r->selected}}>{{$r->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea name="description" class="form-control" id="inputDescription" rows="3"
                                                  placeholder="角色描述">{{$role->description}}</textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" value="{{$role->sort}}" name="sort" class="form-control"
                                               id="inputSort" placeholder="排序，数字越小越靠前"/>
                                    </div>

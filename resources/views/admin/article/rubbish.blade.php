                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a class="btn btn-info" id="batchback">批量还原</a>
...
<script>
    ...
    $(function () {
        ...
        $('#myModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer a').attr('href', '/admin/article/del/' + id);
        });
        //datatable
        $("#example1").DataTable({
            "serverSide": true,
            ...
            "ajax": {
                "url": "/admin/article/getRubbishData",
            },
            "columns": [
                {
                    "data": "id",
        ...
        //批量还原
        $('#batchback').click(function () {
            if (!selected()) {
                alert('请选择文章');
            }
            var aids = getAids();
            location.href = '/admin/article/back/' + aids;
        });
        //批量还原

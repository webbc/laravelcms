                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="source" type="text" class="form-control" id="inputSource"
                                                   placeholder="来源">
                                        </div>
                                        <span id="spanTrueName"></span>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="keywords" type="text" class="form-control" id="inputKeywords"
                                                   placeholder="以分号分隔">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="inputDescription" rows="3"
                                                  placeholder="文章描述" name="description"></textarea>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <script id="editor" name='content' type="text/plain"
                                                    style="width:100%;min-height:300px;"></script>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="{{date('Y/m/d H:i',time())}}" name="createtime" class="form-control" id="datetimepicker"
                                                   placeholder="发布时间">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="titlecolor"
                                                   ...
                                                   id="inputTitlecolor" placeholder="标题颜色" value="#222222">
                                        </div>
                                    </div>
                                    <div class="form-group">

                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a class="btn btn-info" href="{{url('/admin/config/add')}}">添加配置</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
<script>
    $(function () {
        $('#myModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer a').attr('href', '/admin/config/del/' + id);
        });
        $("#example1").DataTable({
            "serverSide": true,
            "processing": true,
            ...
            "ajax": "/admin/config/getExtendData",
            "columns": [
                {"data": "id"},
                {"data": "varname"},
                {"data": "info"},
                ...
                {"data": "type"},
                {
                    ...
                    "render": function (data, type, row) {
                        return "<a href='/admin/config/edit/" + data.id + "'>修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;"

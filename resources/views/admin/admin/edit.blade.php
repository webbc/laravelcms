                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" value="{{$admin->truename}}" name="truename"
                                               class="form-control" id="inputTrueName"
                                               placeholder="真实姓名">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">头像</label>
                                    <img src="/{{$admin->photo}}" alt="该用户还没有设置头像"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" value="{{$admin->telphone}}" name="telphone"
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="span-danger">6-16位，不输入还是老密码</span>
                                </div>
                                <div class="form-group">
